...
public class MemberService {
	...
	public void insert() {
		...
		member = new Member("김조은","test2@test.com");
		memberRepository.save(member);
		
		member = new Member("이조은","test3@test.com");
		memberRepository.save(member);
		...
		member = new Member("강조은","test6@test.com");
		memberRepository.save(member);
		
		member = new Member("창조은","test7@test.com");
		memberRepository.save(member);
	...
	public List<Member> selectByNameLikeDesc(String name2) {
