...
public interface MemberRepository extends JpaRepository<Member, Long>{
	...
	//JPQL 쿼리 from 뒤에 영속성에 있는 엔티티이름
	//엔티티이름 뒤에 별칭을 넣어주고 별칭을 이용하여 가져올 컬럼과 조건 등에 사용
	...
	List<Member> findMembers(@Param("n1")String name2, Sort sort); //Param에 들어가는 변수명 및 String 변수명도 내 마음대로
